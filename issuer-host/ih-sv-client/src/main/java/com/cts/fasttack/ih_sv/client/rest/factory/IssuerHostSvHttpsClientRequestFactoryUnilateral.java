...
@Component("issuerHostSvHttpsClientRequestFactoryUnilateral")
@ConfigurationProperties("spring.client")
public class IssuerHostSvHttpsClientRequestFactoryUnilateral extends SimpleClientHttpRequestFactory {

	private Logger logger = LogManager.getLogger(IssuerHostSvHttpsClientRequestFactoryUnilateral.class);
