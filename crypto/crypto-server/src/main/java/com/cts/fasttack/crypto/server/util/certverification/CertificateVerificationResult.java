...
public class CertificateVerificationResult {
    ...
    /**
     * Constructs a certificate verification result for valid certificate by given
     * certification path.
     */
    ...
    /**
     * Constructs a certificate verification result for invalid certificate by given
     * exception that keeps the problem occurred during the verification process.
     */
