...
public class CRLVerifier {
     ...
     */
    public static void verifyCertificateCRLs(X509Certificate cert, boolean throwIfCannotVerify) throws CertificateVerificationException {
        try {
            ...
            if (ex instanceof CertificateVerificationException) {
                ...
                if (throwIfCannotVerify) {
                    throw new CertificateVerificationException(
                            "Can not verify CRL for certificate: " + cert.getSubjectX500Principal(), ex);
                }
            }
        }
    }
