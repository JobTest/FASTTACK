...
/**
 * <p>Java class for activateCardStatus complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="activateCardStatus">
 *   &lt;complexContent>
...
@XmlType(name = "activateCardStatus", propOrder = {
    "code",
    "message",
    "smsText"
})
public class ActivateCardStatus {

    @XmlElementRef(name = "code", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> code;
    @XmlElementRef(name = "message", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> message;
    @XmlElementRef(name = "smsText", namespace = "http://sab/", type = JAXBElement.class, required = false)
