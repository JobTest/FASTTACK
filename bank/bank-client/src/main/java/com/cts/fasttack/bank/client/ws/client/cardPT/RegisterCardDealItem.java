 ...
 *         &lt;element name="cardHashNum" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "registerCardDealItem", propOrder = {
    "dealNo",
    "cardId",
    "errorCode",
    "errorMessage",
...
public class RegisterCardDealItem {
    ...
    @XmlElementRef(name = "cardHashNum", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cardHashNum;
     ...
     *     
     */
    public JAXBElement<String> getCardHashNum() {
        return cardHashNum;
    }
     ...
     *     
     */
    public void setCardHashNum(JAXBElement<String> value) {
