...
/**
 * <p>Java class for cardTransaction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="cardTransaction">
 *   &lt;complexContent>
...
@XmlType(name = "cardTransaction", propOrder = {
    "date",
    "type",
    "amount",
    "currencyId",
...
public class CardTransaction {
    ...
    @XmlElementRef(name = "date", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> date;
    @XmlElementRef(name = "type", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> type;
    @XmlElementRef(name = "amount", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> amount;
    @XmlElementRef(name = "currencyId", namespace = "http://sab/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> currencyId;
    @XmlElementRef(name = "info", namespace = "http://sab/", type = JAXBElement.class, required = false)
