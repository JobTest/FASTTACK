 ...
 *         &lt;element name="branchType" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getCardDeliveryBranches")
public class GetCardDeliveryBranches {

    @XmlElement(required = true, type = Integer.class, nillable = true)
    protected Integer branchId;
    @XmlElement(required = true, type = Integer.class, nillable = true)
    protected Integer branchType;
