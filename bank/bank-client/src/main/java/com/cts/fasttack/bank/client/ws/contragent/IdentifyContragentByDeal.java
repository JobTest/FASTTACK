...
@XmlRootElement(name = "identifyContragentByDeal")
public class IdentifyContragentByDeal {

    @XmlElementRef(name = "searchString", namespace = "http://sab/", type = JAXBElement.class, required = false)
